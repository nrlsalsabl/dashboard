<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        ...
        <li>
            ...
            <ul id="dropdown-example" class=" {{ Request::is('talent*') || Request::is('staff*') || Request::is('intern*') || Request::is('brand*') || Request::is('agency*') || Request::is('categories*') || Request::is('scope*') || Request::is('project*') || Request::is('position*') ? '' :'hidden'  }} py-2 space-y-2">
                <li>
                ...
                <li>
                   <a href="/scope" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-600 {{ Request::is('scope') ? 'bg-gray-200' : '' }}">Scope</a>
                </li>
                <li>
                   <a href="/project" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-600 {{ Request::is('project') ? 'bg-gray-200' : '' }}">Project</a>
                </li>
            </ul>
        </li>
        <li>
