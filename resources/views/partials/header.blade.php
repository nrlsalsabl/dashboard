    ...
    <div class="w-full mb-1">
                ...
                <ol class="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                    <li class="inline-flex items-center">
                        <span class="inline-flex items-center text-gray-700 hover:text-primary-600 dark:text-gray-300 dark:hover:text-white">
                            ...
                            @if (request()->is('talent', 'staff', 'intern', 'brand', 'agency', 'scope', 'project', 'edit-profile', 'users-list', 'kinerja-intern', 'kinerja-staff', 'position', 'categories'))
                                Administrator
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            @if (request()->is('talent', 'staff', 'intern', 'brand', 'agency', 'categories', 'scope', 'project', 'position'))
        ...
        <div class="sm:flex">
                    ...
                    <div id="dropdownAction" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                            @foreach($scopes as $scope)
                                <li>
                                    <a href="/{{ $search }}?scope={{ $scope->name }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ $scope->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div id="dropdownAction" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                            @foreach($projects as $project)
                                <li>
                                    <a href="/{{ $search }}?project={{ $project->name }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ $project->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                ...
                @can('import data')
                @if (!request()->is('users-list', 'kinerja-intern', 'kinerja-staff', 'earnings', 'spendings', 'position','categories', 'scope', 'project'))
